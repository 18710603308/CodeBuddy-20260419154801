    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="sticky top-0 z-30 backdrop-blur-xl bg-background/80 border-b border-border">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <div className="hidden md:flex items-center gap-1.5 px-3 py-1.5 rounded-lg border bg-emerald-500/10 border-emerald-500/30">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="lg:sticky lg:top-20">
              ...
              <div className="mt-4 rounded-xl border border-border bg-card p-4 hidden lg:block">
                ...
                <p className="mt-3 text-[11px] text-muted-foreground leading-relaxed">
                  数据库在浏览器本地运行（PGlite / PostgreSQL WASM），数据不上传，可随时「重置数据」恢复初始状态。
                </p>
              </div>
            </div>
          </aside>
          ...
          <main className="flex-1 min-w-0 space-y-6">
            ...
            <div className="rounded-xl border border-border bg-card p-5 sm:p-7">
              ...
              <p className="text-sm text-muted-foreground mb-5">在浏览器内置 GaussDB 兼容数据库中编写 SQL，点击「运行」查看结果；不确定时可用「查看答案」对照参考答案并自动比对。</p>
